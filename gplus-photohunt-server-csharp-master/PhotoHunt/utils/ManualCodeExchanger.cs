...
{
    /// <summary>
    /// A utility class that is used to manually exchange an authorization code
    /// for OAuth2 credentials. When "postmessage" is accepted as a redirect URI
    /// for the client library, you should no longer need to use this utility.
    /// </summary>
    /// @author class@google.com (Gus Class)
    public class ManualCodeExchanger : jsonrest<ManualCodeExchanger>
    {
        /// <summary>
        /// Exchanges an OAuth 2.0 authorization code for OAuth 2.0
        /// credentials.
        /// </summary>
