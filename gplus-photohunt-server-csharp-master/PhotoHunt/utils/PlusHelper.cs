...
namespace PhotoHunt.utils
{
    public class PlusHelper
    {
        ...
        public const string BASE_URL = "http://nexus.koein.com/";

        // Get this from https://code.google.com/apis/console
        public const string CLIENT_ID = "1017174350384.apps.googleusercontent.com";
        public const string CLIENT_SECRET = "VmrGCKv07pbcNhWM4NGAFpOe";
